...
//make a form that takes a new button name and pushes it into the original buttons array
//reloop through originalButtons to make newButtons now that the array is bigger
//hint:you will need to empty the buttons div or end up with more buttons than you want appended to the document

$("document").ready(function() {

    var topics = ["Rameses Tarheels", "Jazz Bear", "Benny the Bull", "Cosmo Cougar", "Philly Phanatic", "Sparty", "San Antonio Coyote", "Mr. Met"];
    var numGifs = 10;
    var currentTopic;
    var currentOffset = 0;
